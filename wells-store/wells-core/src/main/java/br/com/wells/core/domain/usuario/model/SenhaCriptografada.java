...
public record SenhaCriptografada(String valor) {
	 ...
	 * @return
	 */
	public static SenhaCriptografada criptografar(final String senha) {
		...
		return new SenhaCriptografada(passwordEncoder.encode(senha));
	}
	 ...
	 * @return
	 */
	public static boolean isSenhaIguais(@NonNull final String senhaAtual, @NonNull final String confirmarSenha) {
		var passwordEncoder = passwordEncoder();

		return !senhaAtual.isEmpty() && passwordEncoder.matches(senhaAtual, confirmarSenha);
	}
