	...
	@Operation(summary = "Recuperar um usuário pelo id",
			...
			responses = {
					...
					@ApiResponse(responseCode = "404", description = "Recurso não encontrado",
							content = @Content(mediaType = "application/json",
									schema = @Schema(implementation = ErrorMessage.class))) })
	ResponseEntity<GenericResponse<UsuarioResponseDto>> consultarUsarioPorId(
			@Parameter(description = "ID do usuário a ser consultado", required = true) Long id);
	...
	@Operation(summary = "Atualizar a senha",
			...
			responses = { @ApiResponse(responseCode = "204", description = "Senha atualizada com sucesso"),
					...
					@ApiResponse(responseCode = "422", description = "Campos invalidos ou mal formatados",
							content = @Content(mediaType = "application/json",
									schema = @Schema(implementation = ErrorMessage.class))) })
	ResponseEntity<GenericResponse<Void>> alterarSenha(
			@Parameter(description = "ID do usuário a ser atualizadao", required = true) Long id,
