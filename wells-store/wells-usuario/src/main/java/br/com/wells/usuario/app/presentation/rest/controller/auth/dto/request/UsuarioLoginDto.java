package br.com.wells.usuario.app.presentation.rest.controller.auth.dto.request;
...
import br.com.wells.usuario.app.presentation.rest.validation.FindInfo;
import jakarta.validation.constraints.Email;
import jakarta.validation.constraints.NotEmpty;
import jakarta.validation.constraints.Size;

public record UsuarioLoginDto(@NotEmpty(groups = {
		FindInfo.class }) @Email(message = "formato do e-mail está invalido",
		...
		@NotEmpty(groups = { FindInfo.class }) @Size(min = 6, max = 6, message = "A senha deve ter 6 caracteres",
