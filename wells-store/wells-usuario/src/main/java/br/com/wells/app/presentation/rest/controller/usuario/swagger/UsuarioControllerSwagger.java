package br.com.wells.app.presentation.rest.controller.usuario.swagger;
...
public interface UsuarioControllerSwagger {
    ...
    @Operation(summary = "Atualizar a senha", description = "Requisição exige um Bearer Token. Acesso restrito a ADMIN|CLIENTE",
            responses = {
